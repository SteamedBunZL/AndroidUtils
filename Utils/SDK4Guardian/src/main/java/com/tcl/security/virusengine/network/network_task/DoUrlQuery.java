...
/**
 * Created by Steve on 16/9/20.
 */
public class DoUrlQuery implements Runnable{
    ...
    public DoUrlQuery(Context context, String url, String json, RequestCallback callback){
