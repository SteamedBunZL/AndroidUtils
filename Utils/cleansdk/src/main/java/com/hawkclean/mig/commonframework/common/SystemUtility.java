package com.hawkclean.mig.commonframework.common;
...
//		WindowManager windowManager = (WindowManager) SpaceApplication.getInstance().getContext().getSystemService(Context.WINDOW_SERVICE);
...
//
//		ConnectivityManager connMgr = (ConnectivityManager) SpaceApplication.getInstance().getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
//
...
//		 intent.setData(uri);
//		 SpaceApplication.getInstance().getContext().sendBroadcast(intent);
//	}
...
//        try {
//            color = SpaceApplication.getInstance().getContext().getResources().getColor(resId);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        return color;
...
//		try {
//			drawable = SpaceApplication.getInstance().getContext().getResources().getDrawable(resId);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		return drawable;
