...
public class CacheHfLangQueryDescTable implements TableHelper<LangQueryDesc>{

    private static final String TAG = CacheHfLangQueryDescTable.class.getSimpleName();
