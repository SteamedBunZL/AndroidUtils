...
public class CacheHfLangPreferDescTable implements TableHelper<LangQueryFormatDesc>{

    private static final String TAG = CacheHfLangPreferDescTable.class.getSimpleName();
