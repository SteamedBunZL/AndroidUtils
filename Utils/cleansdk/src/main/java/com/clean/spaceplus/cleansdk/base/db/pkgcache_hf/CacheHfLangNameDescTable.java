...
public class CacheHfLangNameDescTable implements TableHelper<LangQueryName>{

    private static final String TAG = CacheHfLangNameDescTable.class.getSimpleName();
