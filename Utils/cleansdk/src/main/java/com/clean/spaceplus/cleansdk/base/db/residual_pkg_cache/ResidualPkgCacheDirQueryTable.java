 ...
 * @copyright TCL-MIG
 */
public class ResidualPkgCacheDirQueryTable implements TableHelper<ResidualDirQuery> {

    private static final String TAG = ResidualPkgCacheDirQueryTable.class.getSimpleName();
