...
public class CacheHfLangQueryNameTable implements TableHelper<LangQueryName>{

    private static final String TAG = CacheHfLangQueryNameTable.class.getSimpleName();
