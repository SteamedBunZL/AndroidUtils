 ...
 * @Description: JunkApkWhiteList表构造
 * @date 2016/5/11 15:12
 * @copyright TCL-MIG
 */
public class JunkApkWhiteListTable implements TableHelper<ProcessModel> {

    public static final String TAG = JunkApkWhiteListTable.class.getSimpleName();
    public final static String TABLE_NAME = "JunkApkWhiteList";
